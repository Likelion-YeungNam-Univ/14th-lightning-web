...
function SavedLoading() {
  return <div className="grid grid-cols-5 gap-5 max-[1120px]:grid-cols-3 max-[760px]:grid-cols-1">{Array.from({ length: 5 }, (_, index) => <article key={index} className="min-h-52.5 animate-pulse rounded-xl bg-[#1c2029]" />)}</div>;
}
...
export function SavedCardFeed({
  ...
  return <section className="py-5"><div className="grid auto-rows-fr grid-cols-5 gap-5 max-[1120px]:grid-cols-3 max-[760px]:grid-cols-1">{items.map((item, index) => {
